...
# Created by Rich Trouton: https://derflounder.wordpress.com/2021/01/01/adobe-flash-is-dead-lets-get-it-removed/
# Gist: https://github.com/rtrouton/rtrouton_scripts/tree/master/rtrouton_scripts/uninstallers/adobe_flash_uninstall
